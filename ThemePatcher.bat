...
ECHO ERROR ENCOUNTERED. Multiple android devices are connected through adb.
PAUSE
exit
)
...
del tempfile.tmp
IF %theme% NEQ 0 (
echo Trial theme detected , patching theme...
::Run these codes to patch themes manually
...
IF %font% NEQ 0 (
echo Trial font detected , patching font...
::Run these codes to patch fonts manually
...
IF %livewp% NEQ 0 (
echo Trial live wallpaper detected , patching live wallpaper...
::Run these codes to patch live wallpapers manually
